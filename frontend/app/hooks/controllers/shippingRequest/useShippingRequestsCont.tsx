...
import { DELETE_SHIPPING_REQUEST, SHIPPING_REQUESTS, SAVE_SHIPPING_REQUEST, UPDATE_SHIPPING_REQUEST } from '@/app/graphql/shippingRequest/shippingRequestQueries';
